...
const Sidebar = () => {
    return (
        <div className='bg-[#3e3d45] h-screen rounded-r-lg'>
            ...
            <a href='/Dashboard'><div className= 'flex items-center gap-[15px] px-[20px] py-[20px] border-b-[1px] border-[#EDEDED]/[0.3]'>
            ...
            <a href='/UserList'><div className= 'flex items-center gap-[15px] px-[20px] py-[20px] border-b-[1px] border-[#EDEDED]/[0.3]'>
                ...
                <FaChevronRight className="ml-[15px] transition-transform duration-200 hover:translate-x-2" color= 'white' />
            </div></a>
