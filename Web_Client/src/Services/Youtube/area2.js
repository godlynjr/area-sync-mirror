  ...
  return (
    <div>
      <section className="bg-[#ff0000] text-white py-5">
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col text-center">
            ...
            <p className="text-xl">Envoyer une notification sur Gmail lorsqu'une nouvelle vidéo est mise en ligne par un channel spécifié.</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto flex text-center flex-col">
        ...
        <p className="self-center text-xl">Envoyer une notification sur Gmail lorsqu'une nouvelle vidéo est mise en ligne par un channel spécifié.</p>
      </section>
    </div>
  )
}
