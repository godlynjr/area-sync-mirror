...
function Area1() {
  ...
  return (
    <div>
      <section className="bg-[#d3d3d3] py-5">
        <Header />
      ...
      <section className="container mx-auto flex text-center flex-col">
        <button className="border-4 w-2/5 lg:w-1/6 border-solid p-2 rounded-full my-5 self-center bg-[#d3d3d3]" onClick={ConnectDiscord}>Connect</button>
