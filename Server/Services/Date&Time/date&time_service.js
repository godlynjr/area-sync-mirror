...
const heuresPriere = [
    { heure: '22:34', message: 'Fajr: Bismillah, que cette journée soit bénie. Que votre journée soit remplie de paix et de réussite.' },
    { heure: '22:32', message: 'Dhuhr: Prenez une pause dans votre journée bien remplie pour vous connecter avec Allah. Que votre journée soit remplie de bénédictions.' },
    { heure: '22:30', message: 'Asr: Prenez un moment pour vous recentrer et vous rappeler de la présence d\'Allah dans votre vie. Que votre après-midi soit paisible.' },
    { heure: '22:36', message: 'Maghrib: Bismillah, que la fin de cette journée soit remplie de gratitude. Que votre soirée soit bénie et apaisante.' },
    { heure: '22:38', message: 'Isha: Terminez votre journée en vous tournant vers Allah avec amour et dévotion. Que votre nuit soit paisible et remplie de bénédictions.' }
];
...
function sendEmail(message, res) {
    const mailOptions = {
        from: 'rlaabudo2020@gmail.com',
        to: 'areasync7@gmail.com',
        subject: 'Rappel de prière',
        text: message
    };
...
const definePrayerTime = async (req, res) => {
    try {
        ...
        heuresPriere.forEach(priere => {
            ...
            console.log('Ca veut commencer');
            const scheduleEnvoi = schedule.scheduleJob(regleEnvoi, (res) => {
                console.log(res);
                sendEmail(priere.message, res);
...
module.exports = { router, definePrayerTime };
